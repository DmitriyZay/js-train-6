...
function copyObject(obj) {
  // Використовуємо синтаксис деструктурізації {...person} для створення нового об'єкта
  //з тими ж властивостями
...
console.log(addField(book, "year", 1960));
// Виведе { title: 'To Kill a Mockingbird', author: 'Harper Lee', year: 1960 }
...
function destructureObject(obj) {
  // Використовуємо деструктуризацію для створення нових змінних з властивостей об'єкту
  // і отримуємо з нього змінні brand та model
...
// Створюємо масив об'єктів userList, першим елементом якого буде об'єкт name:"Jack",role:"reader",
// а другим об'єкт name: "Jane", role: 'admin'
...
function printProductDetails(obj) {
  // Використовуємо деструктуризацію для отримання значень productName, price 
  //i також значень companyName, country вкладеного об'єкту manufacturer
...
// Завдання 13: Використовуйте деструктуризацію зі значенням за замовчуванням
// у аргументах функції для об'єкта.
let car = {
  brand: "BMW",
  year: 2022,
};
// Створюємо функцію, яка приймає об'єкт як аргумент і використовує деструктуризацію 
//зі значенням за замовчуванням
// brand за замовчуванням призначемо Unknown, 
//year за замовчуванням призначемо 0, country за замовчуванням призначемо Unknown
